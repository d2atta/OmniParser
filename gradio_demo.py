...
# yes -> "weights/icon_caption_florence"
# no -> "weights/icon_caption_florence_large"
caption_model_processor = get_caption_model_processor(
    model_name="florence2", model_name_or_path="weights/icon_caption_florence_large",
)
...
def process(
    ...
    print(dino_labled_img, label_coordinates, parsed_content_list)
